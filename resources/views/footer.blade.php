...
<footer class="footer-area">
        ...
        <div class="container-fluid">
            <div class="our-service-inner">
                <div class="col-custom">
                    <div class="single-service">
                        <div class="service-icon">
                            <img src="{{ url('img/icon/f-1.png') }}" alt="">
                        </div>
                ...
                <div class="col-custom">
                    <div class="single-service">
                        <div class="service-icon">
                            <img src="{{ url('img/icon/f-2.png')}}" alt="">
                        </div>
                        <div class="serivce-cont">
                ...
                <div class="col-custom">
                    <div class="single-service">
                        <div class="service-icon">
                            <img src="{{ url('img/icon/f-3.png')}}" alt="">
                        </div>
                        <div class="serivce-cont">
                            <h3>Money Return</h3>
                ...
                <div class="col-custom">
                    <div class="single-service">
                        <div class="service-icon">
                            <img src="{{ url('img/icon/f-5.png')}}" alt="">
                ...
                <div class="col-custom">
                    <div class="single-service">
                        <div class="service-icon">
                            <img src="{{ url('img/icon/f-6.png')}}" alt="">
    ...
    {{--                                        <a href="#">--}}
    {{--                                            <img id="zoom1" src="{{assert('img/product/1.jpg')}}" data-zoom-image="img/product/1.jpg"--}}
    {{--                                                 alt="big-1">--}}
    {{--                                        </a>--}}
    {{--                                    </div>--}}
...
<script src="{{ url('js/jquery.mainmenu.js') }}"></script>
<script src="{{ url('js/ajax-email.js') }}"></script>
