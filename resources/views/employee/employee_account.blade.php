        ...
        <div class="row">
            ...
            <div class="col-xl-4 col-lg-6 col-md-6 col-sm-6 col-12">
                ...
                <div class="blog-wrapper mb-30 main-blog">
                    ...
                    <h3>
                        <center><a href="#">No. of bidding records...</a></center>
                    </h3>
                    <div class="blog-meta-bundle">
                        <div class="blog-readmore">
                            <center>
                                ...
                                <?php
//                                $biddingCount = \App\Models\Bidding::count();
                                echo "<b>5 Records</b>";
                                ?>
            ...
            <div class="col-xl-4 col-lg-6 col-md-6 col-sm-6 col-12">
                ...
                <div class="blog-wrapper mb-30 main-blog">
                    ...
                    <h3>
                        <center><a href="#">No. of billings...</a></center>
                    </h3>
                    <div class="blog-meta-bundle">
                        <div class="blog-readmore">
                            <center>
...
//                                echo " <b>" . mysqli_num_rows($qsql) . " Records</b> ";
            ...
            <div class="col-xl-4 col-lg-6 col-md-6 col-sm-6 col-12">
                ...
                <div class="blog-wrapper mb-30 main-blog">
                    ...
                    <h3>
                        <center><a href="#">No. of category...</a></center>
                    </h3>
                    <div class="blog-meta-bundle">
                        <div class="blog-readmore">
                            <center>
...
//                                $qsql = mysqli_query($con, $sql);
            ...
            <div class="col-xl-4 col-lg-6 col-md-6 col-sm-6 col-12">
                ...
                <div class="blog-wrapper mb-30 main-blog">
                    ...
                    <h3>
                        <center><a href="#">No. of customer...</a></center>
                    </h3>
                    <div class="blog-meta-bundle">
                        <div class="blog-readmore">
                            <center>
...
//                                $qsql = mysqli_query($con, $sql);
            ...
            <div class="col-xl-4 col-lg-6 col-md-6 col-sm-6 col-12">
                ...
                <div class="blog-wrapper mb-30 main-blog">
                    ...
                    <h3>
                        <center><a href="#">No. of Employees...</a></center>
                    </h3>
                    <div class="blog-meta-bundle">
                        <div class="blog-readmore">
                            <center>
...
//                                $qsql = mysqli_query($con, $sql);
            ...
            <div class="col-xl-4 col-lg-6 col-md-6 col-sm-6 col-12">
                ...
                <div class="blog-wrapper mb-30 main-blog">
                    ...
                    <h3>
                        <center><a href="#">No. of messages...</a></center>
                    </h3>
                    <div class="blog-meta-bundle">
                        <div class="blog-readmore">
                            <center>
...
//                                $qsql = mysqli_query($con, $sql);
            ...
            <div class="col-xl-4 col-lg-6 col-md-6 col-sm-6 col-12">
                ...
                <div class="blog-wrapper mb-30 main-blog">
                    ...
                    <h3>
                        <center><a href="#">No. of payments...</a></center>
                    </h3>
                    <div class="blog-meta-bundle">
                        <div class="blog-readmore">
                            <center>
...
//                                $qsql = mysqli_query($con, $sql);
            ...
            <div class="col-xl-4 col-lg-6 col-md-6 col-sm-6 col-12">
                ...
                <div class="blog-wrapper mb-30 main-blog">
                    ...
                    <h3>
                        <center><a href="#">No. of products...</a></center>
                    </h3>
                    <div class="blog-meta-bundle">
                        <div class="blog-readmore">
                            <center>
...
//                                $qsql = mysqli_query($con, $sql);
            ...
            <div class="col-xl-4 col-lg-6 col-md-6 col-sma-6 col-12">
                <!-- blog-wrapper start -->
                <div class="blog-wrapper mb-30 main-blog">
                    <div class="blog-img mb-20">
                        <a href="#">
                    ...
                    <h3>
                        <center><a href="#">No. of winners winners...</a></center>
                    </h3>
                    <div class="blog-meta-bundle">
                        <div class="blog-readmore">
                            <center>
