                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-lg-12">
                                            <p class="single-form-row">
                                                ...
                                                <span id='idemployee_name' style="color:red;"></span>
                                                <input type="text" name="employee_name" id="employee_name" class="form-control" value="{{ $rsedit['employee_name'] ?? '' }}">
                                            </p>
                                        </div>
                                        ...
                                        <div class="col-lg-12">
                                            <p class="single-form-row">
                                                ...
                                                <input type="text" name="login_id" id="login_id" class="form-control" value="{{ $rsedit['login_id'] ?? '' }}">
                                            </p>
                                        </div>
                                        ...
                                        <div class="col-lg-12">
                                            <p class="single-form-row">
                                                ...
                                                <input type="password" name="password" id="password" class="form-control" value="{{ $rsedit['password'] ?? '' }}">
                                            </p>
                                        </div>
                                        ...
                                        <div class="col-lg-12">
                                            <p class="single-form-row">
                                                ...
                                                <input type="password" name="cpassword" id="cpassword" class="form-control" value="{{ $rsedit['password'] ?? '' }}">
                                            </p>
                                        </div>
                                        ...
                                        <div class="col-lg-12">
                                            <p class="single-form-row">
                                                ...
                                                <span id='idemployee_type' style="color:red;"></span>
                                                <select name="employee_type" id="employee_type" class="form-control">
                                                    <option value=''>Select Employee type</option>
                                                    @foreach ($employee_types as $type)
                                                        <option value="{{ $type }}" @if (isset($rsedit['employee_type']) && $rsedit['employee_type'] == $type) selected @endif>{{ $type }}</option>
                                                    @endforeach
                                                </select>
                                            </p>
                                        </div>
                                            ...
                                            <p class="single-form-row">
                                                ...
                                                <select name="status" id="status" class="form-control">
                                                    ...
                                                    @foreach ($statuses as $status)
                                                        <option value="{{ $status }}" @if (isset($rsedit['status']) && $rsedit['status'] == $status) selected @endif>{{ $status }}</option>
                                                    @endforeach
                                                </select>
                                            </p>
                                        </div>
