...
@if (request()->has('submit'))
        <?php
        $sql = "UPDATE customer SET password='" . request()->input('npass') . "' WHERE customer_id='" . session('customer_id') . "' AND password='" . request()->input('opass') . "'";
                                        ...
                                        <form action="" method="post" onsubmit="return validateform()"
                                            ...
                                            <section class="creditly-wrapper wthree, w3_agileits_wrapper">
                                                <div class="information-wrapper">
                                                    ...
                                                    <centeR>
                                                        <button class="submit check_out btn btn-lg btn-info"
                                                                type="submit" name="submit">Update Password
                                                        </button>
                                                    </center>
                                                </div>
                                            </section>
