                            ...
                            <div class="checkbox-form checkout-review-order">
                                ...
                                <div class="row">
                                        ...
                                        <div class="product-grid8 border">
                                            ...
                                            <div class="product-content">
                                                <span class="product-shipping"
                                                      style="color: brown;"><b>Product : {{ $winner->product->product_name }}</b></span>
                                                <br>
                                                <span class="product-shipping"
                                                      style="color: brown;"><b>Product Code : {{ $winner->product->product_name }}</b></span>
                                                <br>
                                                <span class="product-shipping"
                                                      style="color: brown;"><b>Company Name: {{ $winner->product->compname }}</b></span>
                                            </div>
                                        </div>
                                    </div>
                                    ...
                                    <div class="col-md-6 col-sm-6 ">
                                        <div class="product-grid8 border">
                                            <div class="product-image8">
                                                <a href="{{ route('product.show', $winner->product->product_id) }}">
                                                    <img class="pic-1"
                                                         src="{{ asset('product_images/' . $winner->product->first_image_path) }}"
                                                         alt=""> </a>
                                                <br>
                                                ...
                                                <div class="product-content">
                                                    <span class="product-shipping"
                                                          style="color: green;"><b>Winner : {{ $winner->customer->customer_name }}</b>
                                                    </span>
                                                    <br>
                                                    <span class="product-shipping"
                                                          style="color: green;"><b>From : {{ $winner->customer->city }}</b>
                                                    </span>
                                                    <br>
                                                    <span class="product-shipping"
                                                          style="color: green;"><b>Amount payable: : Rs. {{ $winner->winning_bid }}</b>
                                                    </span>
                                                </div>
                                            </div>
                                        </div>
                                    ...
                                    <form action="{{ route('payment.submit') }}" method="post"
                                        ...
                                        <div class="row">
                                            ...
                                            <div class="col-md-6">
                                                ...
                                                <div class="form-group">
                                                    ...
                                                    <input name="cvv_number" class="form-control"
                                        ...
                                        <div class="row">
                                            <div class="col-md-12">
                                                <hr>
                                                <center>
                                                    <button type="submit" name="submit" class="btn btn-primary">Click
                                                        here
                                                        to make payment
                                                    </button>
                                                </center>
