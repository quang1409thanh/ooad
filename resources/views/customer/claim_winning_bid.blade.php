    ...
    <div class="w3l_banner_nav_right">
        <div class="w3ls_w3l_banner_nav_right_grid">
            ...
            <div class="container">
                ...
                <form action="{{ route('payment.submit') }}" method="post" class="creditly-card-form agileinfo_form"
                    ...
                    <div class="row">
                        <div class="col-md-6">
                            <div class="form-group">
                                ...
                                <input name="custname" class="form-control" type="text" readonly value="haha">
                            </div>
                            <div class="form-group">
                        ...
                        <div class="col-md-6">
                            <div class="form-group">
                                ...
                                <input name="paid_amount" class="form-control" type="text" placeholder="Paid amount"
                            ...
                            <div class="form-group">
                                ...
                                <input name="card_holder" class="form-control" placeholder="card holder">
                            </div>
                            <div class="form-group">
                            ...
                            <div class="form-group">
                                ...
                                <input name="expire_date" type="month" class="form-control" placeholder="expire date"
                                       min="{{ date('Y-m') }}">
                            </div>
                        </div>
                    </div>
                    <div class="row">
                        <div class="col-md-12">
                            <hr>
                            <center>
                                <button type="submit" name="submit" class="btn btn-primary">Click here to make payment
                                </button>
                            </center>
                            <hr>
                        </div>
