                    ...
                    @foreach($winners as $winner)
                        <div class="col-md-4 col-sm-4 ">
                            <div class="product-grid8 border">
                                ...
                                <span class="product-shipping" style="color: brown;"><b>Product :
                                        {{ $winner->product_name }}
                                    </b></span>
                                    <span class="product-shipping" style="color: brown;"><b>Product Code :
                                        {{ $winner->product_code }}
                                    </b></span>
                                    <a class="all-deals" href="{{ route('product.single', $winner->proid) }}"
                                       target="_blank">View Product <i class="fa fa-angle-right icon"></i></a>
                                </div>
                                <div class="product-content">
                                <span class="product-shipping" style="color: green;"><b>Winner :
                                        {{ $winner->customer_name }}
                                    </b></span>
                                    <span class="product-shipping" style="color: green;"><b>From :
                                        {{ $winner->city }}
                                    </b></span>
                                    <span class="product-shipping" style="color: green;"><b>Amount payable: Rs.
                                        {{ $winner->winning_bid }}
                                    </b></span>

                                    @if ($winner->status == "Pending")
                                        <a class="all-deals"
                                           href="{{ route('pay.winning.bid', $winner->winner_id) }}">Claim winning bid
                                            <i
