                                                    ...
                                                    <div class="first-row form-group">
                                                        ...
                                                        <div class="controls">
                                                            ...
                                                            <input name="product_image" id="product_image"
                                                                   ...
                                                                   placeholder="product images" accept="image/*">
                                                            <br>
                                                            <?php
                                                            if (isset($_GET['editid'])) {
                                                                ?>
                                                        ...
                                                        <div class="w3_agileits_card_number_grid_left">
                                                            <div class="controls">
                                                                ...
                                                                <input name="product_cost" id="product_cost"
                                                        ...
                                                        <div class="w3_agileits_card_number_grid_left">
                                                            <div class="controls">
                                                                ...
                                                                if (isset($_GET['editid'])) {
                                                                    ?>
                                                                <input name="start_date_time" class="form-control"
                                                                       type="date" placeholder="start date and time"
                                                                       min="<?php echo date("Y-m-d"); ?>" value="<?php
                                                                        if (isset($_GET['editid'])) {
                                                        ...
                                                        <div class="w3_agileits_card_number_grid_left">
                                                            <div class="controls">
                                                                ...
                                                                <input name="start_time" class="form-control"
                                                                       ...
                                                                       value="<?php echo date("H:i", strtotime($rsedit['start_date_time'])); ?>"
                                                                       readonly style="background-color:#fcf8e3;">

                                                                    <?php
                                                                } else {
                                                                    ?>
                                                                <input name="start_time" class="form-control"
                                                                       type="time" placeholder="Start time" value="<?php
																																								echo date("H:i");
																																								?>">
                                                        ...
                                                        <div class="w3_agileits_card_number_grid_left">
                                                            <div class="controls">
                                                                ...
                                                                <div id="idend_time">
                                                                    <input style="background-color:#fcf8e3;"
                                                                           name="end_time" class="form-control"
                                                                           type="time" placeholder="End time" value="<?php
                                                                                    if (isset($_GET['editid'])) {
...
*/
        ...
        */
                                                                ...
                                                                <select name="product_delivery" id="product_delivery"
                                                                        class="form-control">
...
<script>
    function validateform() {
        ...
        if (document.getElementById("product_name").value.length > 35) {
